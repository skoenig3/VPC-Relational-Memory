function getVPC_SCW_EyeData(datafile,itmnum)
%modified from getSCM_EyeDat by Seth Konig 6/9/2015
%function imports VPC eye data and calibrates it. 

samprate = 5;

ITMFile = ['C:\Users\seth.koenig\Documents\MATLAB\VPC Relational Memory\Item and CND Files\2IMSC' num2str(itmnum) 'W.ITM'];
