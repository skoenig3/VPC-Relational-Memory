...
%monkeys
% pre_files = {'PW150701.2','PW150706.2','PW150707.2',...
...
post_files = {'PW160520.1','PW160524.2','PW160525.2',...
    'RR160616.2','RR160617.2','RR160620.2',...
    'TO170810.2','TO170811.2','TO170814.2'};
...
legend('Pre','Post')
title('1000-5000 ms')
subtitle(['VPC Black/White : Novelty Preference Over Time: All Monkeys Pre-Lesion'])
